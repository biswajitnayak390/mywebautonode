...
export const metadata: Metadata = {
  ...
  title: {
    default: 'AutonodeAI | Sitecore, CMS, AI & Modern Website Development',
    template: '%s | AutonodeAI'
  },
  description:
    'AutonodeAI designs modern websites, Sitecore solutions, headless CMS platforms, WordPress builds, AI integrations, and technical SEO foundations for growth-focused brands.',
  keywords: [
    'AutonodeAI',
  ...
  openGraph: {
    title: 'AutonodeAI | Sitecore, CMS, AI & Modern Website Development',
    description:
    ...
    locale: 'en_US',
    type: 'website',
    images: [{ url: '/images/hero.jpg', width: 1200, height: 630, alt: 'AutonodeAI website design and CMS services' }]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AutonodeAI | Sitecore, CMS, AI & Modern Website Development',
    description: 'Modern websites, Sitecore CMS, headless platforms, AI features, and technical SEO.',
