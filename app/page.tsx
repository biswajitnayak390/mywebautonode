          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              ...
              <p className="hero-text mb-4">
                ...
                websites, digital experience platforms, and AI-enabled customer
                journeys using Sitecore, WordPress, Contentful, React, Next.js,
                .NET, and headless CMS architecture.
              </p>
              ...
              <div className="hero-trust-grid mt-5">
                ...
                <div className="trust-card">
                  ...
                  <span>
                    Intelligent search, chatbot experiences, and automation that
                    improve engagement and operations.
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="hero-visual">
                ...
                <div className="hero-floating-card">
                  ...
                  <span>
                    ...
                    platforms, we create websites that look premium and perform
                    at scale.
                  </span>
                </div>
              </div>
              ...
              <div className="service-card-light h-100 overflow-hidden">
                ...
                <div className="p-4 text-start">
                  ...
                  <p className="card-copy-dark mb-0">
                    ...
                    Next.js, .NET, and modern front-end architecture for speed,
              ...
              <div className="service-card-light h-100 overflow-hidden">
                ...
                <div className="p-4 text-start">
                  ...
                  <p className="card-copy-dark mb-0">
                    ...
                    implementation designed for content flexibility, governance,
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card-light h-100 overflow-hidden">
                ...
                <div className="p-4 text-start">
                  ...
                  <h3 className="service-title">AI Automation & Integration</h3>
                  <p className="card-copy-dark mb-0">
          ...
          <div className="row align-items-center g-5">
            ...
            <div className="col-lg-6">
              ...
              <h2 className="section-title">
                Build a digital presence that looks premium and performs like an
                enterprise brand
              </h2>
              ...
              <ul className="feature-list mt-4">
                ...
                <li>AI-led digital experiences and automation opportunities</li>
                <li>
        ...
        <div className="container">
          <div className="cta-banner text-center">
            ...
            >
              ...
              implementation, headless CMS strategy, AI integration, or digital
          ...
          <div className="row g-4">
            <div className="col-md-6">
              <div className="faq-card-light h-100">
                ...
                <p className="card-copy-dark mb-0">
                  Yes. We work with Sitecore, WordPress, Contentful, Strapi, and
                  headless CMS architectures depending on your business and
            ...
            <div className="col-md-6">
              <div className="faq-card-light h-100">
                ...
                <p className="card-copy-dark mb-0">
                  Yes. Our websites are structured for clean content hierarchy,
                  metadata, performance, and search visibility from the
                  beginning.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="faq-card-light h-100">
                ...
                <p className="card-copy-dark mb-0">
                  Yes. We can integrate AI chatbots, intelligent search, content
                  automation, and other AI-powered features into digital
            ...
            <div className="col-md-6">
              <div className="faq-card-light h-100">
                ...
                <p className="card-copy-dark mb-0">
                  Simply book a discovery call and share your project goals. We
                  will discuss the right technical approach, platform choice,
